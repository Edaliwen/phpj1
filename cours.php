...
<hr>
            ...
            <p>Elle fonctionne avec la fonction session_start() qui permet de démarrer une session et d'initialiser un tableau vide dans $_SESSION et avec session_destroy() qui permet de détruire la variable</p>    
            <?php
                echo '<br>';
                echo '<pre>';
                var_dump($_SESSION);
...
<hr>
            ...
            <p>$_GET est un tableau vide qui permet de récupérer informations sous forme de clé/valeur dans l'url avec les symboles ?, & et =.<br>
